...
export default function VoiceAssistantPage() {
    ...
    return (
        <main className="login-container" style={{ position: 'relative' }}>
             <Link href="/customer/ai-assistant/text" className="neu-button" style={{ position: 'absolute', top: '25px', right: '25px', width: 'auto', height: 'auto', padding: '12px', margin: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
