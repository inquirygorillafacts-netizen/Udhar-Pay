...
<h2>6. Merchant's Relationship with Customers</h2>
<p>As a merchant (shopkeeper) on Udhar Pay, you are solely responsible for your relationship with your customers. This includes:</p>
<ul>
    <li><strong>Policies:</strong> You must have clear and accessible return, refund, and privacy policies for your customers.</li>
    <li><strong>Dispute Resolution:</strong> Any dispute regarding goods, services, quality, or payment must be resolved directly between you and the customer. Udhar Pay is not responsible for mediating or resolving such disputes.</li>
    <li><strong>Accurate Information:</strong> You must ensure that you do not provide any false or misleading information to your customers regarding your products or services.</li>
</ul>

<h2>7. Chargebacks and Fraud</h2>
<p>A "Chargeback" is a transaction that is reversed by a customer's bank. As a merchant, you are responsible for managing chargebacks.</p>
<ul>
    <li>While Razorpay provides a fraud detection system, you are also responsible for monitoring for potentially fraudulent transactions.</li>
    <li>In the event of a chargeback, you will be given an opportunity to provide evidence to dispute it. However, the final liability for the chargeback amount may rest with you, as per Razorpay's policies.</li>
</ul>
